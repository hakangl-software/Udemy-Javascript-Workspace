...
let kitaplar = [kitap1, kitap2, kitap3, kitap4, kitap5]; // yukarıdakileri diziye ekledik.
...
let raflar = [
  // Rafları şekil olarak göstermek için dizi içinde dizi oluşturduk.
 ...
 //! METOTLARIN NEREDE YAZILDIĞININ ÖNEMİ YOKTUR. NEREDE ÇAĞIRILDIĞININ ÖNEMİ VARDIR.
  
function rafOlustur() {
  console.clear();
  let satir = "";
  for (let i = 0; i < raflar.length; i++) {
    // i ler satır j ler sütunu temsil eder
    for (let j = 0; j < 5; j++) {
